...
// <32-128:8>
// <i> Minimum block allocation size to avoid creating a block too small while
// splitting up an allocated block. <i> Size expressed in bytes and can only be
// a multiple of 8 bytes for the proper data alignment management done by the
// dynamic allocator malloc() function. <i> Default: 32
