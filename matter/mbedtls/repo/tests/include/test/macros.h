...
#define TEST_EQUAL(expr1, expr2)                                               \
  do {                                                                         \
    if (!mbedtls_test_equal(#expr1 " == " #expr2, __LINE__, __FILE__, expr1,   \
                            expr2))                                            \
      goto exit;                                                               \
  } while (0)
...
#define TEST_LE_U(expr1, expr2)                                                \
  do {                                                                         \
    if (!mbedtls_test_le_u(#expr1 " <= " #expr2, __LINE__, __FILE__, expr1,    \
                           expr2))                                             \
      goto exit;                                                               \
  } while (0)
...
#define TEST_LE_S(expr1, expr2)                                                \
  do {                                                                         \
    if (!mbedtls_test_le_s(#expr1 " <= " #expr2, __LINE__, __FILE__, expr1,    \
                           expr2))                                             \
      goto exit;                                                               \
  } while (0)
...
/**
 * \brief   This macro tests the statement passed to it as a test step or
 *          individual test in a test case. The macro assumes the test will not
 * fail.
 *
 *          It assumes the library function under test cannot return a value and
