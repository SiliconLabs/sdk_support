...
psa_status_t mbedtls_test_transparent_cipher_encrypt(
    ...
    size_t key_length, psa_algorithm_t alg, const uint8_t *iv, size_t iv_length,
...
psa_status_t mbedtls_test_opaque_cipher_set_iv(
    mbedtls_opaque_test_driver_cipher_operation_t *operation, const uint8_t *iv,
    size_t iv_length);
...
psa_status_t mbedtls_test_opaque_cipher_finish(
    mbedtls_opaque_test_driver_cipher_operation_t *operation, uint8_t *output,
    size_t output_size, size_t *output_length);
