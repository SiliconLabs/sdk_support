...
typedef MBEDTLS_PSA_DEPRECATED psa_key_usage_t
    mbedtls_deprecated_psa_key_usage_t;
typedef MBEDTLS_PSA_DEPRECATED psa_ecc_family_t
    mbedtls_deprecated_psa_ecc_family_t;
typedef MBEDTLS_PSA_DEPRECATED psa_dh_family_t
...
typedef MBEDTLS_PSA_DEPRECATED psa_algorithm_t
 ...
 */
MBEDTLS_PSA_DEPRECATED static inline psa_status_t
psa_asymmetric_sign(psa_key_handle_t key, psa_algorithm_t alg,
...
MBEDTLS_PSA_DEPRECATED static inline psa_status_t
psa_asymmetric_verify(psa_key_handle_t key, psa_algorithm_t alg,
                      const uint8_t *hash, size_t hash_length,
                      const uint8_t *signature, size_t signature_length) {
  return psa_verify_hash(key, alg, hash, hash_length, signature,
                         signature_length);
}
...
#define PSA_ALG_AEAD_WITH_TAG_LENGTH(aead_alg, tag_length)                     \
  MBEDTLS_DEPRECATED_CONSTANT(                                                 \
      psa_algorithm_t, PSA_ALG_AEAD_WITH_SHORTENED_TAG(aead_alg, tag_length))
...
#define PSA_AEAD_TAG_LENGTH_1_ARG(alg)                                         \
  MBEDTLS_DEPRECATED_CONSTANT(                                                 \
      size_t, PSA_ALG_IS_AEAD(alg) ? PSA_ALG_AEAD_GET_TAG_LENGTH(alg) : 0)
...
#define PSA_AEAD_UPDATE_OUTPUT_SIZE_2_ARG(alg, input_length)                   \
  MBEDTLS_DEPRECATED_CONSTANT(                                                 \
      size_t, PSA_ALG_IS_AEAD_ON_BLOCK_CIPHER(alg)                             \
...
#define PSA_AEAD_FINISH_OUTPUT_SIZE_1_ARG(alg)                                 \
  MBEDTLS_DEPRECATED_CONSTANT(size_t, PSA_ALG_IS_AEAD_ON_BLOCK_CIPHER(alg)     \
