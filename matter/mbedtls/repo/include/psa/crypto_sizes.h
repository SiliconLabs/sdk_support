...
#define PSA_HASH_LENGTH(alg)                                                                                    \
  (PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_MD2                                                                    \
       ? 16                                                                                                     \
       : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_MD4                                                              \
             ? 16                                                                                               \
             : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_MD5                                                        \
                   ? 16                                                                                         \
                   : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_RIPEMD160                                            \
                         ? 20                                                                                   \
                         : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_1                                          \
                               ? 20                                                                             \
                               : PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_224                                  \
                                     ? 28                                                                       \
...
#define PSA_AEAD_NONCE_LENGTH(key_type, alg)                                   \
  (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) == 16                               \
       ? MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_CCM)                          \
             ? 13                                                              \
             : MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_GCM) ? 12 : 0           \
