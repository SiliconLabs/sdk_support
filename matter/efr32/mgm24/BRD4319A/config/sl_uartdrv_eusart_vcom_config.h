...
// EUSART1 TX on PD01
#define SL_UARTDRV_EUSART_VCOM_TX_PORT           SL_GPIO_PORT_D
#define SL_UARTDRV_EUSART_VCOM_TX_PIN            1

// EUSART1 RX on PD00
#define SL_UARTDRV_EUSART_VCOM_RX_PORT           SL_GPIO_PORT_D
#define SL_UARTDRV_EUSART_VCOM_RX_PIN            0

// EUSART1 CTS on PC03
#define SL_UARTDRV_EUSART_VCOM_CTS_PORT          SL_GPIO_PORT_C
#define SL_UARTDRV_EUSART_VCOM_CTS_PIN           3

// EUSART1 RTS on PC02
#define SL_UARTDRV_EUSART_VCOM_RTS_PORT          SL_GPIO_PORT_C
