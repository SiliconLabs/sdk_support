...
UARTDRV_Handle_t sl_uartdrv_eusart_vcom_handle =
    &sl_uartdrv_eusart_vcom_handle_data;
...
DEFINE_BUF_QUEUE(SL_UARTDRV_EUSART_VCOM_RX_BUFFER_SIZE,
                 sl_uartdrv_eusart_vcom_rx_buffer);
DEFINE_BUF_QUEUE(SL_UARTDRV_EUSART_VCOM_TX_BUFFER_SIZE,
                 sl_uartdrv_eusart_vcom_tx_buffer);
...
void sl_uartdrv_init_instances(void) {
  UARTDRV_InitEuart(sl_uartdrv_eusart_vcom_handle,
                    &sl_uartdrv_eusart_init_vcom);
