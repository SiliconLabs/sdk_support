...
typedef struct {
  uint32_t RESERVED0[23U];                           /**< Reserved for future use                            */
...
typedef struct {
  ...
  uint32_t                  RESERVED18[53U];         /**< Reserved for future use                            */
  ...
  uint32_t                  RESERVED32[53U];         /**< Reserved for future use                            */
  ...
  uint32_t                  RESERVED46[53U];         /**< Reserved for future use                            */
