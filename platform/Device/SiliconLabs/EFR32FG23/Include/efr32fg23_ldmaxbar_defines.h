...
#define _LDMAXBAR_CH_REQSEL_SIGSEL_LESENSELESENSE_FIFO    0x00000000UL /** Mode LESENSELESENSE_FIFO for LDMAXBAR_CH_REQSEL**/
#define _LDMAXBAR_CH_REQSEL_SIGSEL_LCDLCD                 0x00000000UL /** Mode LCDLCD for LDMAXBAR_CH_REQSEL**/
...
#define LDMAXBAR_CH_REQSEL_SIGSEL_LESENSELESENSE_FIFO     (_LDMAXBAR_CH_REQSEL_SIGSEL_LESENSELESENSE_FIFO << 0) /** Shifted Mode LESENSELESENSE_FIFO for LDMAXBAR_CH_REQSEL**/
#define LDMAXBAR_CH_REQSEL_SIGSEL_LCDLCD                  (_LDMAXBAR_CH_REQSEL_SIGSEL_LCDLCD << 0)              /** Shifted Mode LCDLCD for LDMAXBAR_CH_REQSEL**/
