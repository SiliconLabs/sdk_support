...
import bgm22.PythonSnippet.RuntimeModel as RuntimeModel
import bgm22.PythonSnippet.ExporterModel as ExporterModel
import bgm22.PythonSnippet.Metadata as Metadata
import bgm22.modules.PIN.PIN_Snippets as PIN_Snippets
import bgm22.modules.PORTIO.PORTIO_Snippets as PORTIO_Snippets
import bgm22.halconfig.halconfig_dependency as dep

import bgm22.modules.ANTDIV.ANTDIV_behavior as ANTDIV_behavior
import bgm22.modules.BTL_BUTTON.BTL_BUTTON_behavior as BTL_BUTTON_behavior
import bgm22.modules.BUTTON.BUTTON_behavior as BUTTON_behavior
import bgm22.modules.CMU.CMU_behavior as CMU_behavior
import bgm22.modules.COEX.COEX_behavior as COEX_behavior
import bgm22.modules.DCDC.DCDC_behavior as DCDC_behavior
import bgm22.modules.EMU.EMU_behavior as EMU_behavior
import bgm22.modules.EUART0.EUART_behavior as EUART_behavior
import bgm22.modules.EXTFLASH.EXTFLASH_behavior as EXTFLASH_behavior
import bgm22.modules.EZRADIOPRO.EZRADIOPRO_behavior as EZRADIOPRO_behavior
import bgm22.modules.FEM.FEM_behavior as FEM_behavior
import bgm22.modules.GPIO.GPIO_behavior as GPIO_behavior
import bgm22.modules.I2C0.I2C_behavior as I2C_behavior
import bgm22.modules.I2C1.I2C_behavior as I2C_behavior
import bgm22.modules.I2CSENSOR.I2CSENSOR_behavior as I2CSENSOR_behavior
import bgm22.modules.IADC0.IADC_behavior as IADC_behavior
import bgm22.modules.IOEXP.IOEXP_behavior as IOEXP_behavior
import bgm22.modules.LED.LED_behavior as LED_behavior
import bgm22.modules.MODEM.MODEM_behavior as MODEM_behavior
import bgm22.modules.PA.PA_behavior as PA_behavior
import bgm22.modules.PDM.PDM_behavior as PDM_behavior
import bgm22.modules.PRS.PRS_behavior as PRS_behavior
import bgm22.modules.PTI.PTI_behavior as PTI_behavior
import bgm22.modules.SERIAL.SERIAL_behavior as SERIAL_behavior
import bgm22.modules.SPIDISPLAY.SPIDISPLAY_behavior as SPIDISPLAY_behavior
import bgm22.modules.SPINCP.SPINCP_behavior as SPINCP_behavior
import bgm22.modules.TIMER0.TIMER_behavior as TIMER_behavior
import bgm22.modules.TIMER1.TIMER_behavior as TIMER_behavior
import bgm22.modules.TIMER2.TIMER_behavior as TIMER_behavior
import bgm22.modules.TIMER3.TIMER_behavior as TIMER_behavior
import bgm22.modules.TIMER4.TIMER_behavior as TIMER_behavior
import bgm22.modules.UARTNCP.UARTNCP_behavior as UARTNCP_behavior
import bgm22.modules.USART0.USART_behavior as USART_behavior
import bgm22.modules.USART1.USART_behavior as USART_behavior
import bgm22.modules.VCOM.VCOM_behavior as VCOM_behavior
import bgm22.modules.VUART.VUART_behavior as VUART_behavior
import bgm22.modules.WDOG.WDOG_behavior as WDOG_behavior
import bgm22.upgrade as upgrade
import bgm22.upgrade.upgradeDispatch as upgradeDispatch
PROFILE = True
