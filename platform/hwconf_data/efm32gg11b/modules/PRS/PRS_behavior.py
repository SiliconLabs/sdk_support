...
PRS_CHANNEL_COUNT = 24
PRS_CHANNEL_GPIO_COUNT = 24
PRS_SOURCE_TO_SIGNALS_MAP = {
    'PRS': ['PRS_CH0', 'PRS_CH1', 'PRS_CH2', 'PRS_CH3', 'PRS_CH4', 'PRS_CH5', 'PRS_CH6', 'PRS_CH7', 'PRS_CH8', 'PRS_CH9', 'PRS_CH10', 'PRS_CH11', 'PRS_CH12', 'PRS_CH13', 'PRS_CH14', 'PRS_CH15', 'PRS_CH16', 'PRS_CH17', 'PRS_CH18', 'PRS_CH19', 'PRS_CH20', 'PRS_CH21', 'PRS_CH22', 'PRS_CH23', ],
    'ACMP0': ['ACMP0_OUT', ],
    'ACMP1': ['ACMP1_OUT', ],
    ...
    'USART5': ['USART5_TXC', 'USART5_RXDATAV', 'USART5_RTS', 'USART5_TX', 'USART5_CS', ],
    ...
    'WTIMER2': ['WTIMER2_UF', 'WTIMER2_OF', 'WTIMER2_CC0', 'WTIMER2_CC1', 'WTIMER2_CC2', ],
    'WTIMER3': ['WTIMER3_UF', 'WTIMER3_OF', 'WTIMER3_CC0', 'WTIMER3_CC1', 'WTIMER3_CC2', ],
    'TIMER4': ['TIMER4_UF', 'TIMER4_OF', 'TIMER4_CC0', 'TIMER4_CC1', 'TIMER4_CC2', ],
    'TIMER5': ['TIMER5_UF', 'TIMER5_OF', 'TIMER5_CC0', 'TIMER5_CC1', 'TIMER5_CC2', ],
    'TIMER6': ['TIMER6_UF', 'TIMER6_OF', 'TIMER6_CC0', 'TIMER6_CC1', 'TIMER6_CC2', ],
}
