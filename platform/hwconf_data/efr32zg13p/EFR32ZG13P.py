...
import efr32zg13p.modules.PIN.PIN_Snippets as PIN_Snippets
import efr32zg13p.modules.PORTIO.PORTIO_Snippets as PORTIO_Snippets
import efr32zg13p.halconfig.halconfig_dependency as dep

import efr32zg13p.modules.ACMP0.ACMP_behavior as ACMP_behavior
import efr32zg13p.modules.ACMP1.ACMP_behavior as ACMP_behavior
import efr32zg13p.modules.ADC0.ADC_behavior as ADC_behavior
import efr32zg13p.modules.ANTDIV.ANTDIV_behavior as ANTDIV_behavior
import efr32zg13p.modules.BATTERYMON.BATTERYMON_behavior as BATTERYMON_behavior
import efr32zg13p.modules.BTL_BUTTON.BTL_BUTTON_behavior as BTL_BUTTON_behavior
import efr32zg13p.modules.BULBPWM.BULBPWM_behavior as BULBPWM_behavior
import efr32zg13p.modules.BULBPWM_COLOR.BULBPWM_COLOR_behavior as BULBPWM_COLOR_behavior
import efr32zg13p.modules.BUTTON.BUTTON_behavior as BUTTON_behavior
import efr32zg13p.modules.CMU.CMU_behavior as CMU_behavior
import efr32zg13p.modules.COEX.COEX_behavior as COEX_behavior
import efr32zg13p.modules.CS5463.CS5463_behavior as CS5463_behavior
import efr32zg13p.modules.CSEN.CSEN_behavior as CSEN_behavior
import efr32zg13p.modules.DCDC.DCDC_behavior as DCDC_behavior
import efr32zg13p.modules.EMU.EMU_behavior as EMU_behavior
import efr32zg13p.modules.EXTFLASH.EXTFLASH_behavior as EXTFLASH_behavior
import efr32zg13p.modules.EZRADIOPRO.EZRADIOPRO_behavior as EZRADIOPRO_behavior
import efr32zg13p.modules.FEM.FEM_behavior as FEM_behavior
import efr32zg13p.modules.GPIO.GPIO_behavior as GPIO_behavior
import efr32zg13p.modules.I2C0.I2C_behavior as I2C_behavior
import efr32zg13p.modules.I2C1.I2C_behavior as I2C_behavior
import efr32zg13p.modules.I2CSENSOR.I2CSENSOR_behavior as I2CSENSOR_behavior
import efr32zg13p.modules.IDAC0.IDAC_behavior as IDAC_behavior
import efr32zg13p.modules.IOEXP.IOEXP_behavior as IOEXP_behavior
import efr32zg13p.modules.LED.LED_behavior as LED_behavior
import efr32zg13p.modules.LEUART0.LEUART_behavior as LEUART_behavior
import efr32zg13p.modules.MODEM.MODEM_behavior as MODEM_behavior
import efr32zg13p.modules.PA.PA_behavior as PA_behavior
import efr32zg13p.modules.PRS.PRS_behavior as PRS_behavior
import efr32zg13p.modules.PTI.PTI_behavior as PTI_behavior
import efr32zg13p.modules.PYD1698.PYD1698_behavior as PYD1698_behavior
import efr32zg13p.modules.SERIAL.SERIAL_behavior as SERIAL_behavior
import efr32zg13p.modules.SPIDISPLAY.SPIDISPLAY_behavior as SPIDISPLAY_behavior
import efr32zg13p.modules.SPINCP.SPINCP_behavior as SPINCP_behavior
import efr32zg13p.modules.TIMER0.TIMER_behavior as TIMER_behavior
import efr32zg13p.modules.TIMER1.TIMER_behavior as TIMER_behavior
import efr32zg13p.modules.UARTNCP.UARTNCP_behavior as UARTNCP_behavior
import efr32zg13p.modules.USART0.USART_behavior as USART_behavior
import efr32zg13p.modules.USART1.USART_behavior as USART_behavior
import efr32zg13p.modules.USART2.USART_behavior as USART_behavior
import efr32zg13p.modules.VCOM.VCOM_behavior as VCOM_behavior
import efr32zg13p.modules.VDAC0.VDAC_behavior as VDAC_behavior
import efr32zg13p.modules.VUART.VUART_behavior as VUART_behavior
import efr32zg13p.modules.WDOG.WDOG_behavior as WDOG_behavior
import efr32zg13p.modules.WTIMER0.WTIMER_behavior as WTIMER_behavior
import efr32zg13p.upgrade as upgrade
import efr32zg13p.upgrade.upgradeDispatch as upgradeDispatch
PROFILE = True
