...
/*****************************************************************************
 * Callback function that is used to notify the application whenever a KEYSCAN
 * event occurs. Will be called by the keyscan ISR when keyscan data is ready to
 * be processed by the application.
 *
 * @param [in]  p_keyscan_matrix   Pointer to keyscan array containing the data.
 *
 * @param [in]  status             Status of the keyscan.
 ******************************************************************************/
 ...
 *
 * @param event_handle  Event handle to register
 *
 * @note  An EFM_ASSERT is thrown if the handle is NULL.
 * @note  Must be called before init function.
 ******************************************************************************/
...
*
* @note  An EFM_ASSERT is thrown if the handle is not found or is NULL.
*****************************************************************************/
