...
#define _HFXO_CTRL_FORCERAWCLK_SHIFT                  31
#define _HFXO_CTRL_FORCERAWCLK_MASK                   0x80000000UL
#define HFXO_CTRL_FORCERAWCLK                        (0x1UL << _HFXO_CTRL_FORCERAWCLK_SHIFT)
...
#endif
#define _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT           8
#define _HFXO_PKDETCTRL_PKDETTHSTARTUPI_MASK            0xF00UL
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V105MV          (0x00000000UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V132MV          (0x00000001UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V157MV          (0x00000002UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V184MV          (0x00000003UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V210MV          (0x00000004UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V236MV          (0x00000005UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V262MV          (0x00000006UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V289MV          (0x00000007UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V315MV          (0x00000008UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V341MV          (0x00000009UL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V367MV          (0x0000000AUL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V394MV          (0x0000000BUL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V420MV          (0x0000000CUL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V446MV          (0x0000000DUL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V472MV          (0x0000000EUL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
#define HFXO_PKDETCTRL_PKDETTHSTARTUPI_V499MV          (0x0000000FUL << _HFXO_PKDETCTRL_PKDETTHSTARTUPI_SHIFT)
...
#define SLEEPY_XTAL_SETTING_DEFAULT_PKDETTHSTARTUPI  HFXO_PKDETCTRL_PKDETTHSTARTUPI_V157MV
...
void sl_hfxo_manager_irq_handler(void)
{
  ...
  if (irq_flag & HFXO_IF_RDY) {
    ...
    if (error_flag) {
      ...
      if (error_try_cnt <= 1) {
        ...
        HFXO0->PKDETCTRL = (HFXO0->PKDETCTRL & ~_HFXO_PKDETCTRL_PKDETTHSTARTUPI_MASK) | pkdettusstartupi_saved;
  ...
  if (irq_flag & HFXO_IF_DNSERR) {
    ...
    pkdettusstartupi_saved = (HFXO0->PKDETCTRL & _HFXO_PKDETCTRL_PKDETTHSTARTUPI_MASK);
    ...
    HFXO0->CTRL_SET = HFXO_CTRL_FORCERAWCLK;
    while ((HFXO0->STATUS & _HFXO_STATUS_ENS_MASK) != 0U) {
    }
    HFXO0->CTRL_CLR = HFXO_CTRL_FORCERAWCLK;

    // Change settings:
    //Reduce Peak Detection Threshold for Startup Intermediate stage to 2 (V157MV)
    HFXO0->PKDETCTRL = (HFXO0->PKDETCTRL & ~_HFXO_PKDETCTRL_PKDETTHSTARTUPI_MASK) | sleepy_xtal_settings_pkdettusstartupi;
