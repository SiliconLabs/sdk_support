...
#define DEFINE_POWERUP_GPIO_CFG_VARIABLES()                                                       \
  uint16_t gpioCfgPowerUp[6] = {                                                                  \
    ((GPIOCFG_UNUSED     << _GPIO_P_CFGL_Px0_SHIFT)                                               \
     | (GPIOCFG_UNUSED     << _GPIO_P_CFGL_Px1_SHIFT)                                             \
     | (GPIOCFG_UNUSED     << _GPIO_P_CFGL_Px2_SHIFT)                                             \
     | (GPIOCFG_UNUSED     << _GPIO_P_CFGL_Px3_SHIFT)),                                           \
    ...
    ((GPIO_P_CFGz_Pxy_IN_PUD     << _GPIO_P_CFGL_Px0_SHIFT)                                       \
     | (GPIO_P_CFGz_Pxy_OUT_ALT    << _GPIO_P_CFGL_Px1_SHIFT)                       /* SC1MISO */ \
     | (GPIO_P_CFGz_Pxy_IN         << _GPIO_P_CFGL_Px2_SHIFT)                       /* SC1MOSI */ \
     | (GPIO_P_CFGz_Pxy_IN         << _GPIO_P_CFGL_Px3_SHIFT)),                     /* SC1SCLK */ \
    ((GPIO_P_CFGz_Pxy_IN         << _GPIO_P_CFGH_Px4_SHIFT)                         /* SC1nSSEL*/ \
...
#define DEFINE_POWERUP_GPIO_OUTPUT_DATA_VARIABLES()                                      \
  uint8_t gpioOutPowerUp[3] = {                                                          \
    ((GPIOOUT_UNUSED     << _GPIO_P_OUT_Px0_SHIFT)                                       \
     | (GPIOOUT_UNUSED     << _GPIO_P_OUT_Px1_SHIFT)                                     \
     | (GPIOOUT_UNUSED     << _GPIO_P_OUT_Px2_SHIFT)                                     \
     | (GPIOOUT_UNUSED     << _GPIO_P_OUT_Px3_SHIFT)                                     \
    ...
    ((1                  << _GPIO_P_OUT_Px0_SHIFT)                                       \
     | (1                  << _GPIO_P_OUT_Px1_SHIFT)                       /* SC1MISO */ \
     | (1                  << _GPIO_P_OUT_Px2_SHIFT)                       /* SC1MOSI */ \
     | (1                  << _GPIO_P_OUT_Px3_SHIFT)                       /* SC1SCLK */ \
     | (1                  << _GPIO_P_OUT_Px4_SHIFT)                       /* SC1nSSEL*/ \
