...
#define DEFINE_POWERUP_GPIO_CFG_VARIABLES()                                                       \
  uint16_t gpioCfgPowerUp[9] = {                                                                  \
    ...
    ((GPIOCFG_UNUSED     << _GPIO_P_CFGL_Px0_SHIFT)                                               \
     | (GPIO_P_CFGz_Pxy_OUT_ALT    << _GPIO_P_CFGL_Px1_SHIFT)                       /* SC3TXD  */ \
     | (GPIO_P_CFGz_Pxy_IN_PUD     << _GPIO_P_CFGL_Px2_SHIFT)                       /* SC3RXD  */ \
     | (GPIO_P_CFGz_Pxy_IN_PUD     << _GPIO_P_CFGL_Px3_SHIFT)),                     /* SC3nCTS */ \
    ((GPIO_P_CFGz_Pxy_OUT_ALT    << _GPIO_P_CFGH_Px4_SHIFT)                         /* SC3nRTS */ \
...
#define DEFINE_POWERDOWN_GPIO_OUTPUT_DATA_VARIABLES()                                             \
  uint8_t gpioOutPowerDown[5] = {                                                                 \
    ...
    ((GPIOOUT_UNUSED     << _GPIO_P_OUT_Px0_SHIFT)                                                \
     | (1                  << _GPIO_P_OUT_Px1_SHIFT)                         /* SC3TXD  */        \
     | (1                  << _GPIO_P_OUT_Px2_SHIFT)                         /* SC3RXD  */        \
     | (GPIO_P_OUT_Pxy_PULLDOWN   << _GPIO_P_OUT_Px3_SHIFT)                         /* SC3nCTS */ \
     | (0                  << _GPIO_P_OUT_Px4_SHIFT)                         /* SC3nRTS */        \
     | (GPIOOUT_UNUSED     << _GPIO_P_OUT_Px5_SHIFT)                                              \
     | (GPIOOUT_UNUSED     << _GPIO_P_OUT_Px6_SHIFT)                                              \
     | (GPIOOUT_UNUSED     << _GPIO_P_OUT_Px7_SHIFT)),                                            \
...
#define SET_POWERUP_GPIO_CFG_REGISTERS() \
  ...
  GPIO->P[3].CFGL = gpioCfgPowerUp[6];   \
  GPIO->P[3].CFGH = gpioCfgPowerUp[7];   \
  GPIO->P[4].CFGL = gpioCfgPowerUp[8];
...
#define SET_POWERDOWN_GPIO_CFG_REGISTERS() \
  ...
  GPIO->P[3].CFGL = gpioCfgPowerDown[6];   \
  GPIO->P[3].CFGH = gpioCfgPowerDown[7];   \
  GPIO->P[4].CFGL = gpioCfgPowerDown[8];
