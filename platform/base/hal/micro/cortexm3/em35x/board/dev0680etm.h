...
//@{
  ...
  #define PWRUP_CFG_TD0               GPIO_P_CFGz_Pxy_OUT_ALT
  #define PWRUP_CFG_TD1               GPIO_P_CFGz_Pxy_OUT_ALT
  #define PWRUP_CFG_TD2               GPIO_P_CFGz_Pxy_OUT_ALT
  #define PWRUP_CFG_TD3               GPIO_P_CFGz_Pxy_OUT_ALT
  #define PWRUP_CFG_TCLK              GPIO_P_CFGz_Pxy_OUT_ALT
...
#else
  #define PWRUP_CFG_TD0               GPIO_P_CFGz_Pxy_OUT_ALT
  #define PWRUP_CFG_TD1               GPIO_P_CFGz_Pxy_IN
  #define PWRUP_CFG_TD2               GPIO_P_CFGz_Pxy_OUT
  #define PWRUP_CFG_TD3               GPIO_P_CFGz_Pxy_OUT
  #define PWRUP_CFG_TCLK              GPIO_P_CFGz_Pxy_IN
...
/**
 * @brief This define is used as a trigger to enable the TX_ACTIVE alternate
 * function on PC5.
 * Default is to not enable TX_ACTIVE functionality on PC5.
 */
//#define ENABLE_ALT_FUNCTION_TX_ACTIVE 1
...
#define DEFINE_POWERUP_GPIO_CFG_VARIABLES()                                                       \
  uint16_t gpioCfgPowerUp[6] = {                                                                  \
    ...
    ((PWRUP_CFG_TD2      << _GPIO_P_CFGL_Px0_SHIFT)                                               \
    ...
    ((PWRUP_CFG_TD1      << _GPIO_P_CFGL_Px0_SHIFT)                                               \
     | (PWRUP_CFG_TD3      << _GPIO_P_CFGL_Px1_SHIFT)                                             \
     | (PWRUP_CFG_TD0      << _GPIO_P_CFGL_Px2_SHIFT)                                             \
     | (PWRUP_CFG_TCLK     << _GPIO_P_CFGL_Px3_SHIFT)),                                           \
...
#define DEFINE_POWERUP_GPIO_OUTPUT_DATA_VARIABLES()                                      \
  uint8_t gpioOutPowerUp[3] = {                                                          \
    ...
    ((PWRUP_OUT_TD2      << _GPIO_P_OUT_Px0_SHIFT)                                       \
    ...
    ((PWRUP_OUT_TD1      << _GPIO_P_OUT_Px0_SHIFT)                                       \
     | (PWRUP_OUT_TD3      << _GPIO_P_OUT_Px1_SHIFT)                                     \
     | (PWRUP_OUT_TD0      << _GPIO_P_OUT_Px2_SHIFT)                                     \
     | (PWRUP_OUT_TCLK     << _GPIO_P_OUT_Px3_SHIFT)                                     \
