...
#define DEFINE_POWERUP_GPIO_CFG_VARIABLES()                                                         \
  uint16_t gpioCfgPowerUp[6] = {                                                                    \
    ((GPIO_P_CFGz_Pxy_IN         << _GPIO_P_CFGL_Px0_SHIFT)                         /* HOST_MOSI */ \
     | (GPIO_P_CFGz_Pxy_OUT_ALT    << _GPIO_P_CFGL_Px1_SHIFT)                       /* HOST_MISO */ \
     | (GPIO_P_CFGz_Pxy_IN         << _GPIO_P_CFGL_Px2_SHIFT)                       /* HOST_SCLK */ \
     | (GPIO_P_CFGz_Pxy_IN_PUD     << _GPIO_P_CFGL_Px3_SHIFT)),                     /* HOST_nSEL */ \
    ...
    ((GPIO_P_CFGz_Pxy_OUT        << _GPIO_P_CFGL_Px0_SHIFT)                                         \
     ...
     | (GPIO_P_CFGz_Pxy_OUT        << _GPIO_P_CFGL_Px2_SHIFT)                       /* HOST_nINT */ \
     | (GPIO_P_CFGz_Pxy_IN         << _GPIO_P_CFGL_Px3_SHIFT)),                                     \
    ((GPIO_P_CFGz_Pxy_OUT        << _GPIO_P_CFGH_Px4_SHIFT)                         /* HOST_nINT'*/ \
     | (GPIO_P_CFGz_Pxy_OUT        << _GPIO_P_CFGH_Px5_SHIFT)                                       \
     | (GPIO_P_CFGz_Pxy_IN_PUD     << _GPIO_P_CFGH_Px6_SHIFT)                       /* HOST_nWAKE*/ \
...
#define DEFINE_POWERDOWN_GPIO_OUTPUT_DATA_VARIABLES()         \
  uint8_t gpioOutPowerDown[3] = {                             \
    ...
    ((0                  << _GPIO_P_OUT_Px0_SHIFT)            \
     ...
     | (GPIO_P_OUT_Pxy_PULLUP     << _GPIO_P_OUT_Px2_SHIFT)   \
     | (GPIO_P_OUT_Pxy_PULLUP     << _GPIO_P_OUT_Px3_SHIFT)   \
     | (GPIO_P_OUT_Pxy_PULLUP     << _GPIO_P_OUT_Px4_SHIFT)   \
