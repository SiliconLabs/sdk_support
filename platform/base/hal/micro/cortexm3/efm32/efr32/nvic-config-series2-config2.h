...
/* *INDENT-OFF**/
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     16,      CRYPTOACC_IRQHandler,        CRYPTOACC_IRQn,       CRYPTOACC_IRQHandler,            4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     17,           TRNG_IRQHandler,             TRNG_IRQn,           TRNG_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     18,            PKE_IRQHandler,              PKE_IRQn,            PKE_IRQHandler,             4,         0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     21,SMU_NS_PRIVILEGED_IRQHandler,SMU_NS_PRIVILEGED_IRQn,SMU_NS_PRIVILEGED_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     22,            EMU_IRQHandler,              EMU_IRQn,            EMU_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     23,         TIMER0_IRQHandler,           TIMER0_IRQn,         TIMER0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     24,         TIMER1_IRQHandler,           TIMER1_IRQn,         TIMER1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     25,         TIMER2_IRQHandler,           TIMER2_IRQn,         TIMER2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     26,         TIMER3_IRQHandler,           TIMER3_IRQn,         TIMER3_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     27,         TIMER4_IRQHandler,           TIMER4_IRQn,         TIMER4_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     28,           RTCC_IRQHandler,             RTCC_IRQn,           RTCC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     29,      USART0_RX_IRQHandler,        USART0_RX_IRQn,      USART0_RX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     30,      USART0_TX_IRQHandler,        USART0_TX_IRQn,      USART0_TX_IRQHandler,             4,         0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     55,      RDMAILBOX_IRQHandler,        RDMAILBOX_IRQn,      RDMAILBOX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     56,        RFSENSE_IRQHandler,          RFSENSE_IRQn,        RFSENSE_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     57,         PROTRC_IRQHandler,           PRORTC_IRQn,         PRORTC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     58,          SYNTH_IRQHandler,            SYNTH_IRQn,          SYNTH_IRQHandler,             4,         0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     60,          HFXO0_IRQHandler,            HFXO0_IRQn,          HFXO0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     61,         HFRCO0_IRQHandler,           HFRCO0_IRQn,         HFRCO0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     62,            CMU_IRQHandler,              CMU_IRQn,            CMU_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     63,            AES_IRQHandler,              AES_IRQn,            AES_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     64,           IADC_IRQHandler,             IADC_IRQn,           IADC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     65,            MSC_IRQHandler,              MSC_IRQn,            MSC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     66,          DPLL0_IRQHandler,            DPLL0_IRQn,          DPLL0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     67,            PDM_IRQHandler,              PDM_IRQn,            PDM_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     68,            SW0_IRQHandler,              SW0_IRQn,            SW0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     69,            SW1_IRQHandler,              SW1_IRQn,            SW1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     70,            SW2_IRQHandler,              SW2_IRQn,            SW2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     71,            SW3_IRQHandler,              SW3_IRQn,            SW3_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     72,        KERNEL0_IRQHandler,          KERNEL0_IRQn,        KERNEL0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     73,        KERNEL1_IRQHandler,          KERNEL1_IRQn,        KERNEL1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     74,        M33CTI0_IRQHandler,          M33CTI0_IRQn,        M33CTI0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     75,        M33CTI1_IRQHandler,          M33CTI1_IRQn,        M33CTI1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     76,         EMUEFP_IRQHandler,           EMUEFP_IRQn,         EMUEFP_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     77,           DCDC_IRQHandler,             DCDC_IRQn,           DCDC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     78,      EUART0_RX_IRQHandler,        EUART0_RX_IRQn,      EUART0_RX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     79,      EUART0_TX_IRQHandler,        EUART0_TX_IRQn,      EUART0_TX_IRQHandler,             4,         0)
