...
// USART0 TX on PE10
#define SL_SPINCP_TX_PORT                        gpioPortE
#define SL_SPINCP_TX_PIN                         10
#define SL_SPINCP_TX_LOC                         0

// USART0 RX on PE11
#define SL_SPINCP_RX_PORT                        gpioPortE
#define SL_SPINCP_RX_PIN                         11
#define SL_SPINCP_RX_LOC                         0

// USART0 CS on PE13
#define SL_SPINCP_CS_PORT                        gpioPortE
#define SL_SPINCP_CS_PIN                         13
#define SL_SPINCP_CS_LOC                         0

// USART0 CLK on PE12
#define SL_SPINCP_CLK_PORT                       gpioPortE
