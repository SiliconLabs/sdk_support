...
#define SL_SPINCP_TX_PIN                         6
#define SL_SPINCP_TX_LOC                         1

// USART2 RX on PA7
#define SL_SPINCP_RX_PORT                        gpioPortA
#define SL_SPINCP_RX_PIN                         7
#define SL_SPINCP_RX_LOC                         1

// USART2 CS on PA9
#define SL_SPINCP_CS_PORT                        gpioPortA
#define SL_SPINCP_CS_PIN                         9
#define SL_SPINCP_CS_LOC                         1

// USART2 CLK on PA8
#define SL_SPINCP_CLK_PORT                       gpioPortA
#define SL_SPINCP_CLK_PIN                        8
#define SL_SPINCP_CLK_LOC                        1
