...
#define IOT_SPI_CFG_MIKROE_PERIPHERAL      USART1
#define IOT_SPI_CFG_MIKROE_PERIPHERAL_NO   1

#define IOT_SPI_CFG_MIKROE_TX_PORT         gpioPortA
#define IOT_SPI_CFG_MIKROE_TX_PIN          0
#define IOT_SPI_CFG_MIKROE_TX_LOC          0

#define IOT_SPI_CFG_MIKROE_RX_PORT         gpioPortA
#define IOT_SPI_CFG_MIKROE_RX_PIN          0
#define IOT_SPI_CFG_MIKROE_RX_LOC          0

#define IOT_SPI_CFG_MIKROE_CLK_PORT        gpioPortA
#define IOT_SPI_CFG_MIKROE_CLK_PIN         1
#define IOT_SPI_CFG_MIKROE_CLK_LOC         0

#define IOT_SPI_CFG_MIKROE_CS_PORT         gpioPortA
#define IOT_SPI_CFG_MIKROE_CS_PIN          2
#define IOT_SPI_CFG_MIKROE_CS_LOC          0
// [USART_IOT_SPI_CFG_MIKROE$
// <<< sl:end pin_tool >>>
