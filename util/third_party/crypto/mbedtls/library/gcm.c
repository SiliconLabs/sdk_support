...
#if defined(SILABS_SUPPORT) && defined(MBEDTLS_GCM_ALT)
            /*
             * IV not equal 12 bytes is not supported by the ALT implementation
             * provided by Silabs.
             */
            if ( iv_len_test_data[i] != 12 ) {
                mbedtls_printf( "skipped\n" );
                break;
            }
#endif /* SILABS_SUPPORT && MBEDTLS_GCM_ALT */
